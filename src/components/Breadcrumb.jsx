...
const Breadcrumb = ({ title, backgroundImage }) => {
  ...
  return (
    <div
      className="flex items-center justify-between p-6 rounded-lg bg-blue-600 mb-5 shadow-md w-full"
    ...
    >
      <div>
        ...
        <nav className="flex items-center text-white text-sm mt-1" aria-label="Breadcrumb">
              ...
              return (
                <li key={fullPath} className="flex items-center">
                  ...
                  {isLast ? (
                    ...
                    <Link to={fullPath} className="hover:text-white">
                      {formattedPath}
                    </Link>
                  )}
                </li>
